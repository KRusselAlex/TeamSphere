  ...
  <DashboardTemplate>
    <div class="flex flex-col gap-2 py-4">
      ...
      <div class="grid md:grid-cols-2 gap-3 lg:grid-cols-4">
        <CardDash title="Nombre total" size="9"> <svg fill="currentColor" width="40px" height="40px" viewBox="0 0 16 16"
        ...
        <CardDash title="Approuvé" size="9"><svg fill="#28A745" width="60px" height="60px" viewBox="-1.7 0 20.4 20.4"
        ...
        <CardDash title=" Rejeté" size="9"><svg width="43px" height="43px" viewBox="0 0 15 15" fill="none"
        ...
        <CardDash title="En attente" size="9"><svg width="60px" height="60px" viewBox="0 0 1024 1024" class="icon"
