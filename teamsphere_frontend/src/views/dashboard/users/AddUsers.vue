...
<template>
  <DashboardTemplate>
    <div class="mx-auto p-8">
      <h2 class="text-2xl font-semibold text-primaryColor mb-6 text-sans">Ajouter un utilisateur</h2>
        ...
        <form @submit.prevent="handleSubmit">
          ...
          <div class="grid grid-cols-1 grid-cols-2">
            <div class="flex items-center mb-6">
              ...
              <button type="button"
                class="bg-primaryColor bg-opacity-70 text-white py-2 px-4 rounded-full hover:bg-opacity-90"
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div class="flex flex-col">
              <label class="text-sm font-semibold text-gray-600 mb-1 ">Role</label>
              <select name="" id=""
                class="px-4 py-2 border rounded-lg focus:outline-none bg-white py-2.5 focus:ring-2 focus:ring-primaryColor">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div class="flex flex-col">
              <label class="text-sm font-semibold text-gray-600 mb-1"> mot de passe</label>
